...
public class SandboxArreglos
{
    ...
    public void insertarEntero( int entero, int posicion )
    {
    	...
    	else if(posicion > nuevoArreglo.length - 1)
    	{
    		posicion = nuevoArreglo.length - 1;
    	}
    ...
    public int[] buscarEntero( int valor )
    {
        ...
        int[] arregloPosiciones = new int[count];
        int index = 0;
        for (int i = 0; i < arregloEnteros.length; i++)
        {
        	if (arregloEnteros[i] == valor)
    ...
    public HashMap<Integer, Integer> calcularHistograma( )
    {
        ...
        for (int i = 0; i < arregloEnteros.length; i++)
        {
        	histograma.put(arregloEnteros[i], histograma.getOrDefault(arregloEnteros[i], 0) + 1);
        }
        return histograma;
    }
    ...
    public boolean mismosEnteros( int[] otroArreglo )
    {
    	...
    	return histogramaEnteros.equals(histogramaOtro);
    }
