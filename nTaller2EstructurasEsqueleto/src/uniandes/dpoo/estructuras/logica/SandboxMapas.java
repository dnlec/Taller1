...
public class SandboxMapas
{
    ...
    {
        List<String> valoresMapa = new ArrayList<String>();
        for (String valor : mapaCadenas.values())
        {
            valoresMapa.add(valor);
        }
        Collections.sort(valoresMapa);
        return valoresMapa;
    }
    ...
    {
    	List<String> llavesMapa = new ArrayList<String>();
        for (String llave : mapaCadenas.keySet())
        {
            llavesMapa.add(llave);
        }
        Collections.sort(llavesMapa, Collections.reverseOrder());
        return llavesMapa;
    }
